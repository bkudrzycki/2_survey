...
ys_panel <- read_sav("data/youth_survey/youth_survey_panel2.zsav", user_na = TRUE)
...
ys_panel$status <- factor(ys_panel$status, levels=c("Apprentice", "In School", "Employed", "Self-Employed", "NEET"))
...
save(ys_panel, file = "data/youth_survey/ys_panel.rda")
save(ys_panel_labels, file = "data/youth_survey/ys_panel_labels.rda")
