...
An analysis of transitions from school to work is central to any analysis of the performance of youth in the labour market. 

The youth population in Sub-Saharan Africa is rapidly growing and is expected to continue to do so for the foreseeable future. This presents both challenges and opportunities for the region. Despite recent increases in educational levels in sub-Saharan Africa, which have increased young people's potential to become gainfully employed, youth continue to be less likely to find jobs and more likely to remain unemployed than adults.

Understanding the factors that influence the transition of young people into the labor market can help policymakers and other stakeholders to identify and implement interventions that can improve economic outcomes for young people and help to support sustainable economic growth in the region. Additionally, studying youth labor market transitions can provide insight into the broader socio-economic dynamics of the region and can help to inform policy decisions in other areas, such as education and training.

Youth constitute a significant portion of the population in the region and their ability to gain employment and enter the labor market has significant implications for economic growth and development. Understanding the factors that affect the transition from education to employment can inform policy interventions aimed at improving the employment prospects of young people. Finally, the study of youth labor market transitions can provide insights into the broader economic and social challenges facing the region, such as poverty, inequality, and gender discrimination.
...
We use a combination of methods to estimate the determinants of transition age and duration in an informal, urban, and low-income setting. We also develop a typology of transitions observable in our data using optimal matching analysis (OMA), a method originally used for DNA sequencing and now applied to variety of contexts.

We first estimate the transition duration and age of transition into the labor market. Since our data is limited to three years of survey data and 7 years of recall data, a proportion of our sample did not transition within the observed time period. We use survival analysis to account for this, though the results are not affected much by whether right-censoredness of the data is accounted for or not. 

Regression analysis is used to identify factors associated with longer transition durations or later transitions.

Second, we 

[ask the question]

We first use a combination of youth event history and a detailed four-wave panel to estimate the age of school-leaving, first employment, and first steady employment. Second, we use the panel data to map out young people's transition between schooling and training, wage employment, self-employment, and inactivity, as well as their propensity to move between more differentiated employment states, such as casual and formal wage employment. Optimal matching analysis (OMA), a technique used to identify groups of similar states of sequences, is used to identify clusters of youth that follow similar trajectories over the observed period. Finally, we leverage the panel data to estimate the effect of various transitions on youth well-being, as measured by reported life satisfaction.
...
From a methodological standpoint, three approaches might suit our data in the literature: 1) look at flows (transition matrices), look for heterogeneous effects and spells in each state [@cunningham2011], 2) survival analysis to estimate transition duration and probability of labor market exit, plus subgroup analysis, and 3) regression of outcomes on earlier labor market experience, e.g. first job experience. I go into more detail below, with the help of a nice summary of the SWT literature for developing countries by @nilsson2019.
...
A third empirical approach to transition is to study transition matrices. @cunningham2011 do this for panel labor force surveys from Argentina, Brazil, and Mexico and find a common pattern: a short time spent in the informal sector, followed by a move to a formal position for longer spells, and finally entry into self-employment at advanced age. Formal and poor workers less likely to return to school, and females have less turnover. Looking at different income groups, the authors find that the poor experience a higher rate of entry to work upon leaving school, the same duration in jobs, and equal entry rates to formal wage employment, but are more likely to transition between states.

In addition to education, the importance of networks\footnote{@nordman2015 identify the importance of network strength on reducing labor market
...
We combine reported activity history data with our panel to approximate the age of graduation and the duration of transition to the first job for each youth. In addition, we estimate transition matrices and sequence analysis to describe common paths along the SWT. Finally, we discuss the impact of specific activity transitions on youth life satisfaction and the reported aspirations of youth, and the obstacles they face on the labor market.
